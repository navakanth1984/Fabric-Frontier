# Global Creative Logic: NVIDIA NIM Integration

## Creative Engine Configuration
- **Primary Model**: meta/llama-3.1-70b-instruct (NVIDIA NIM)
- **Base URL**: https://integrate.api.nvidia.com/v1
- **Temperature**: 0.7 for creative exploration; 0.3 for structural analysis.
...
- When generating new scenes, prioritize the 'Master Story Architect' persona.
