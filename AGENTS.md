...
├── SESSION_REGISTRY.md        ← Master index (read first)
├── _HANDOFF_TEMPLATE.md       ← Template for new notes
├── S-001_2026-06-01_*.md      ← Individual session notes
└── S-002_2026-06-04_*.md
```
